    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <p>
                    Benvenuto sul nostro sito per cercare il <strong>lavoro</strong> che hai sempre <strong>desiderato</strong>.
                </p>
                <p>
                    Registrati per candidarti alle <strong>offerte di lavoro</strong> che più ti aggradano o, in alternativa, per pubblicarne una tu!
                </p>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="input-group">
                                ...
                                <input 
                                    type="text" 
                                    name="username" 
                                    placeholder="Nome utente/azienda" 
