...
class Login extends Component {
    ...
    resetPassword(e, email) {
        e.preventDefault();
        EmailSchema.isValid({email: email})
            .then(res => {
                if(res === false)
                    return toast.error("Inserisci un'email per recuperarla.");
        ...
        return (
            <div className="App">
                <div className="container">
                    ...
                    <p>Digita i dati inseriti alla registrazione per effettuare il <strong>login</strong>.</p>
                    <Formik
